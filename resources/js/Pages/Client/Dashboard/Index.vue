<template>
    <div>
        <div v-for="post in postsData"
             class="mb-4 p-4 border border-gray-200 bg-white"
        >
            <div class="items-center">
                <div>
                    ...
                    <div class="flex justify-end">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" :fill="post.liked_profiles_count > 0 ? '#000' : 'none'" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="cursor-pointer size-6">
